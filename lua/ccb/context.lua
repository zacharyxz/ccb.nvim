---File path and line number reference formatting for ccb (Claude Code).
...
---
---Examples:
---  `lua/ccb/init.lua:L42`            -- cursor line only
---  `lua/ccb/init.lua:L21:C5-L35`     -- range with start col
---
